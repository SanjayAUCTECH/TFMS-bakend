...
public interface IFloorService
{
    ...
    Task<ApiResponse<FloorResponse>> CreateAsync(CreateFloorRequest request, int? userId = null);
    Task<ApiResponse<FloorResponse>> UpdateAsync(int id, UpdateFloorRequest request, int? userId = null);
