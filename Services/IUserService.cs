...
public interface IUserService
{
    ...
    Task<ApiResponse<UserResponse>>              CreateAsync(CreateUserRequest request, int? userId = null);
    Task<ApiResponse<UserResponse>>              UpdateAsync(int id, UpdateUserRequest request, int? userId = null);
