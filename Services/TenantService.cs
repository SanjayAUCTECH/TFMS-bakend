...
public class TenantService : ITenantService
{
    ...
    {
        Id = id, Type = r.Type, Name = r.Name?.Trim() ?? "",
        Passport            = r.Passport?.Trim(),
        Nationality         = r.Nationality?.Trim(),
        EmiratesId          = r.EmiratesId?.Trim(),
        ...
        PlotNo              = r.PlotNo?.Trim(),
        MakaniNo            = r.MakaniNo?.Trim(),
        PropertyArea        = r.PropertyArea?.Trim(),
        PremisesNo          = r.PremisesNo?.Trim(),
        LessorName          = r.LessorName?.Trim(),
        LessorEid           = r.LessorEid?.Trim(),
        LessorLicense       = r.LessorLicense?.Trim(),
        LessorLicAuthority  = r.LessorLicAuthority?.Trim(),
        LessorEmail         = r.LessorEmail?.Trim(),
        LessorPhone         = r.LessorPhone?.Trim(),
    };
