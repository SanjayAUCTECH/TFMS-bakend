...
public interface IRoomService
{
    ...
    Task<ApiResponse<RoomResponse>> CreateAsync(CreateRoomRequest request, int? userId = null);
    Task<ApiResponse<RoomResponse>> UpdateAsync(int id, UpdateRoomRequest request, int? userId = null);
