...
public interface IFundPoolService
{
    ...
    Task<ApiResponse<FundPoolResponse>> CreateAsync(CreateFundPoolRequest request, int? userId = null);
    Task<ApiResponse<FundPoolResponse>> UpdateAsync(int id, UpdateFundPoolRequest request, int? userId = null);
