...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            UPDATE FundPools SET Balance = ISNULL(Balance, 0) + @FundPoolAdjustment, UpdatedAt = GETDATE() WHERE Code = @FundPool AND ISNULL(IsDeleted, 0) = 0;
        END
        COMMIT TRANSACTION;
    END TRY
    BEGIN CATCH
...
PRINT 'sp_CreateAccountMaster updated successfully with NEW FundPool logic!';
GO
