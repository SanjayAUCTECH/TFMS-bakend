...
public class OtherPersonRepository : IOtherPersonRepository
{
    ...
    public async Task<bool> UpdateAsync(OtherPerson op)
    {
        ...
        cmd.Parameters.AddWithValue("@Designation", op.Designation);
        cmd.Parameters.AddWithValue("@Name",        op.Name);
        cmd.Parameters.AddWithValue("@Mobile",      (object?)op.Mobile   ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@Email",       (object?)op.Email    ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@Address",     (object?)op.Address  ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@City",        (object?)op.City     ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@State",       (object?)op.State    ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@Pincode",     (object?)op.Pincode  ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@Remarks",     (object?)op.Remarks  ?? DBNull.Value);
        cmd.Parameters.AddWithValue("@Status",      op.Status);
