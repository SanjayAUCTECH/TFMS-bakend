-- ============================================================
-- 134: Add missing columns + Fix sp_CreateOwnerContract
--      PaymentMode, ReferenceNo, Month ab InstallmentsJson se save honge
-- Date: Aug 1, 2026
-- ============================================================
USE TFMS_TestSoftwareDB;
GO

-- ── Step 1: OwnerContracts — missing columns add karo ─────────
...
GO
PRINT '✅ OwnerContracts columns checked/added';
GO

-- ── Step 2: OwnerInstallments — missing columns add karo ──────
...
GO
PRINT '✅ OwnerInstallments columns checked/added';
GO

-- ── Step 3: OwnerMonthlyContractInstallments ──────────────────
...
GO
PRINT '✅ OwnerMonthlyContractInstallments columns checked/added';
GO

-- ── Step 4: OwnerTransactions ─────────────────────────────────
...
GO
PRINT '✅ OwnerTransactions columns checked/added';
GO

-- ── Step 5: sp_CreateOwnerContract — fix karo ─────────────────
