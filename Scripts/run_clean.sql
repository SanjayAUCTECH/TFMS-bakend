-- Step 1: Disable FK constraints on all target tables
...
-- Step 2: Delete all data from target tables
DELETE FROM Waivers;
...
PRINT 'DONE - All data cleaned. Kept: AppUsers, Floors, RoomStatuses, PaymentModes, Roles';
GO
